...
M08 (Coolant on)
(BEGIN CUTTING)
G83 G99 Z-0.45 R0.25 Q0.05 F7.64 (Drill hole at current X Y location)
G80 (Cancels all active canned cycles)
(END CUTTING)
G00 Z0.1 M09 (Rapid retract, Coolant off)
G53 G49 Z0.0 M05 (Z home, Spindle off) 
...
M08 (Coolant on)
(BEGIN CUTTING)
G83 G99 Z-0.35 R0.25 Q0.05 F6.1 (Drill hole at current X Y location)
G80 (Cancels all active canned cycles)
(END CUTTING)
G00 Z0.1 M09 (Rapid retract, Coolant off)
G53 G49 Z0.0 M05 (Z home, Spindle off) 
...
M08 (Coolant on)
(BEGIN CUTTING)
G83 G99 Z-0.35 R0.25 Q0.05 F9.15 (Ream hole at current X Y location)
G80 (Cancels all active canned cycles)
(END CUTTING)
G00 Z0.1 M09 (Rapid retract, Coolant off)
G53 G49 Z0.0 M05 (Z home, Spindle off) 
